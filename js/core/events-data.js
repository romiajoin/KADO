...
// 2026/09/15：補回缺漏的分類（POP-UP／展覽／CAFÉ・餐廳／特典活動／實境解謎／路跑），
// 原本只剩 3 項，導致「類型」篩選面板選不到其他 6 種、且既有的「音樂會/演唱會」「簽名會/見面會」
// 少了 Sheet B 欄實際文字裡「/」兩邊的空格，篩了也比對不到任何活動；九項都跟 Sheet B 欄目前
// 實際出現的文字逐字核對過。
export const EVENT_CATEGORIES = [
  { key: 'collab',    label: '聯名活動',        color: '#FF6B6B' },
  { key: 'concert',   label: '音樂會 / 演唱會', color: '#FFB74D' },
  { key: 'meetgreet', label: '簽名會 / 見面會', color: '#81C784' },
  { key: 'popup',     label: 'POP-UP',          color: '#2BADB9' },
  { key: 'expo',      label: '展覽',            color: '#0066FF' },
  { key: 'cafe',      label: 'CAFÉ / 餐廳',     color: '#BE185D' },
  { key: 'tokuten',   label: '特典活動',        color: '#7C3AED' },
  { key: 'escape',    label: '實境解謎',        color: '#EAB308' },
  { key: 'running',   label: '路跑',            color: '#78716C' },
];
