  ...
  function render(bar) {
    ...
    group.innerHTML = `
      <button class="sort-btn" id="sortBtn" type="button">
        ...
        <svg class="sort-icon-mobile" xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="currentColor"><path d="M180-264q-15.3 0-25.65-10.29Q144-284.58 144-299.79t10.35-25.71Q164.7-336 180-336h168q15.3 0 25.65 10.29Q384-315.42 384-300.21t-10.35 25.71Q363.3-264 348-264H180Zm.29-180q-15.29 0-25.79-10.29t-10.5-25.5q0-15.21 10.34-25.71t25.63-10.5h359.74q15.29 0 25.79 10.29t10.5 25.5q0 15.21-10.34 25.71T540.03-444H180.29ZM180-624q-15.3 0-25.65-10.29Q144-644.58 144-659.79t10.35-25.71Q164.7-696 180-696h600q15.3 0 25.65 10.29Q816-675.42 816-660.21t-10.35 25.71Q795.3-624 780-624H180Z"/></svg>
      </button>
