...
// 資料源是 docs/changelog.json（資料夾整理後從根目錄搬過去，這裡的 fetch 路徑要跟著改，
// 不然抓不到檔案，畫面會顯示成「目前沒有更新紀錄」），跟 Notion 上的「使用者版更新日誌」
// 頁面內容保持一致，之後每次上版，記完開發日誌後，記得也在 docs/changelog.json 補一筆
// 使用者向的一句話說明。
// =============================================
...
async function loadChangelog() {
  ...
  try {
    const res = await fetch('docs/changelog.json');
