...
**最後更新：** 2026/09/05（v33.2，活動分享連結改用永久ID、全站篩選「IP」更名「作品」、桌機地圖模式恢復顯示 FAB；見下方說明）
...
- 🗓️ **全新「活動行事曆」頁面**（`events.html`，v32 新增）：整理全台動漫快閃店／聯名展覽／簽名會／CAFÉ 聯名／特典活動等實體活動
  ...
  - 活動詳情彈窗：同一檔活動在多城市開時可切換城市頁籤、支援多圖輪播、點擊放大（v33.1 新增）、一鍵分享（v33.1 起分享連結有動態專屬預覽縮圖，見下方「活動分享連結」）
